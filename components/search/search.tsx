    ...
    <NavigationMenu.Root className="relative z-[1] flex w-full justify-end sm:pr-5">
      <NavigationMenu.List className="center m-0 flex list-none rounded-[6px] p-1 ">
        <NavigationMenu.Item className="flex">
          ...
          <NavigationMenu.Content className="data-[motion=from-start]:animate-enterFromLeft data-[motion=from-end]:animate-enterFromRight data-[motion=to-start]:animate-exitToLeft data-[motion=to-end]:animate-exitToRight sm:w-auto sm:h-full border">
      ...
      <div className="perspective-[2000px] absolute top-full w-max sm:left-0 flex sm:w-full justify-end left-[-8.75rem]">
        <NavigationMenu.Viewport className="w-[85vw] data-[state=open]:animate-scaleIn data-[state=closed]:animate-scaleOut relative mt-[10px] h-[var(--radix-navigation-menu-viewport-height)] origin-[top_center] overflow-hidden rounded-[6px] bg-white transition-[width,_height] duration-300 sm:w-[var(--radix-navigation-menu-viewport-width)] shadow-md" />
      </div>
    </NavigationMenu.Root>
  );
};
